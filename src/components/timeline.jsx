      ...
      <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
        <li>
          ...
          <div className="timeline-start mb-10 md:text-end">
            <time className="font-mono italic">Senin 1985</time>
        ...
        <li>
          ...
          <div className="timeline-end md:mb-10">
            <time className="font-mono italic"> selasa 1998</time>
            <div className="text-lg font-black">Daisyui</div>
            DaisyUI is a Tailwind CSS component library that provides a set of
            pre-designed UI components and styles. It is built on top of   
          </div>
          <hr />
        </li>
        <li>
          ...
          <div className="timeline-start mb-10 md:text-end">
            ...
            <div className="text-lg font-black">Luice</div>
            Luice is a modern CSS framework that provides a set of utility-first
            classes for building responsive and customizable user interfaces. It
          </div>
          <hr />
        </li>
        <li>
